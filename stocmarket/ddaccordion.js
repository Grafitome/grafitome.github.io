...
ddaccordion.init({
	...
	togglehtml: ["suffix", "<img src='pls.png' class='statusicon' />", "<img src='drop.png' class='statusicon' />"], //Additional HTML added to the header when it's collapsed and expanded, respectively  ["position", "html1", "html2"] (see docs)
