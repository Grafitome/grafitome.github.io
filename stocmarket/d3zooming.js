d3 = function() {
  ...
  d3.behavior.zoom = function() {
    var translate = [ 0, 0 ], translate0, scale = 1, scale0, scaleExtent = d3_behavior_zoomInfinity, event = d3_eventDispatch(zoom, "zoom"), x0, x1, xExtent = d3_behavior_scaleInfinity, y0, y1, yExtent = d3_behavior_scaleInfinity, touchtime;
    function zoom() {
  ...
  var d3_behavior_zoomInfinity = [ 0, Infinity ], d3_behavior_scaleInfinity = [ -Infinity, Infinity ];
