...
function copyChartToCanvas(chartContainerId,canvasId,callback){
					...
					})(function () { //canvasToImage("black",canvasId);
						console.log("image drawing to canvas done"); 
						if(callback){
							callback();
						}
					});
				...
				function postImage() {
						...
						var data = {};
						data.media = (document.getElementById("canvas2").toDataURL("image/png").toString("base64")).substring(22);
						data.message = "message";
						var uri = "http://localhost:3080/twitterMedia";
						var method='POST';
						...
						$.ajax({
							...
							success: function(data) {
								window.open("/sessions/connect","_blank");
