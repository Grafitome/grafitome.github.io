...
$(document).ready(function(){
 ...
 var textStyleConfg={"font-family":"Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif","font-size":"11","background":"none","tick-font-color":"black","legendTextColor":"black","font-weight":300,"xLabelColor":"black","yLabelColor":"black","chartTitleColor":"black"};
  $("#basicLineChartMenu").click(function(){
	
	  $(".chartBigOuter").hide();	
	  $("#basicLineChart").find("#line1").empty();
	  ...
	  var basicLineData =
		...
		setTimeout(function(){
			var textStyleConfg={"font-family":"Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif","font-size":"12","background":"none","tick-font-color":"black","legendTextColor":"black","font-weight":300,"xLabelColor":"black","yLabelColor":"black","chartTitleColor":"black"};
  ...
  $("#scatterPlotChartMenu").click(function(){
	...
	$("#scatterPlotChart").find("#line2").empty();
   ...
   $("#drillDownChartMenu").click(function(){
		...
		$("#drillDownChart").find("#line3").empty();
		
		var barData = {
					
					
					'IE':{data:5,color:"#e67a77","subData":{'v5.0':31,'v6.0':10,'v7.0':20,'v8.0':53,'v9.0':25,'v10.0':35,'v11.0':23},subDataColorArray:['#e67a77','#95d7bb','#fcb322','#6d788e','#aec785','#a48ad4','purple']},
					...
					'Opera':{data:5,color:"#6d788e","subData":{},subDataColorArray:[]},
					'Not Known':{data:5,color:"#aec785","subData":{},subDataColorArray:[]}
		...
		$("#drillDownChart").show();
		var stocChart3=$("#line3").stocCharts(textStyleConfg);
		stocChart3.drawDrillDownChart("#line3", barData,cfgDrillDown);
	...
	*/
	...
	//	var legendSet=['Agnitio','Apple Inc','IBM','Facebook','Accenture',"Gold Man Sach"];
		...
		var stocChart5=$("#line5").stocCharts(textStyleConfg);
    ...
    $("#radarChartMenu").click(function(){
		...
		$("#radarChart").show();
		var stocChart6=$("#line6").stocCharts(textStyleConfg);
	...
	//	var textStyleConfg={"font-family":"Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif","font-size":"12","background":"none","font-color":"green","font-weight":300,"xLabelColor":"red","legendTextColor":"red"};
		var stocChartLineBars=$("#line7").stocCharts(textStyleConfg);
    ...
    $("#groupedBarMenu").click(function(){
		...
		var colorJson={"pending":"#7cb5ec","approved":"#434348","rejected":"#90ed7d","halted":"#f9b169"};
	...
	$("#3DBarChartMenu").click(function(){
		...
		var stocChart10=$("#line10").stocCharts(textStyleConfg);
	    stocChart10.drawThreeDBarChart("#line10", barData, cfg3DBarChart);
	...
	$("#3DGroupedBarChartMenu").click(function(){
		...
		$("#3DGroupedBarChart").find("#line38").empty();
		...
		var cfg3DBarChart = {
			...
			barColorArray : ['#63d2ff','#16ffb5'],
			xLabel:"Year",
			yLabel:"Sales(in Crores)"
		}
		var stocChart38=$("#line38").stocCharts(textStyleConfg);
	    stocChart38.drawThreeDGroupedBarChart("#line38", barDataOne, barDataTwo, cfg3DBarChart);
	 ...
	 $("#3DStackedBarChartMenu").click(function(){
		...
		$("#3DStackedBarChart").find("#line27").empty();
		...
		var textColor = "Grey";
		var textStyleConfg1={"font-family":"Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif","font-size":"12","background":"none","font-color":"green","font-weight":300,"axisTextColor":"purple","legendTextColor":"purple"};
		var stocChart27=$("#line27").stocCharts(textStyleConfg1);
		var xAxisArray = ['1994', '1995', '1996', '1997', '1998', '1999','2000','2001','2002','2003', '2004', '2005', '2006'];
	    stocChart27.drawThreeDStackedBarChart("#line27", heightOfBarOne, heightOfBarTwo, threeDStackedBarsData, cfg3DBarChart, colorArray, gridLineColor, textColor, xAxisArray);
		
	});
	  
	$("#stackedAreaChartMenu").click(function(){
		$(".chartBigOuter").hide();		
		$("#stackedAreaChart").find("#line11").empty();
		...
		var stocChart11=$("#line11").stocCharts(textStyleConfg);
	...
	$("#stackedBarChartMenu").click(function(){
		$(".chartBigOuter").hide();		
		$("#stackedBarChart").find("#line12").empty();
		...
		d3.json("getBuisinessDetailByChannel.json", function(error, treeData) {
			...
			var colorArray={"settledAmount":"#f9b169","unsettledAmount":"#99D373"};
			var stockChart12=$("#line12").stocCharts(textStyleConfg);
    ...
    $("#guageGraphMenu").click(function(){
		...
		$("#guageGraph").find("#line15").empty();
		$("#guageGraph").show();
		
		var dataA=generateData(100,10000);
		var stockChart15=$("#line15").stocCharts();
		stockChart15.gaugeGraph({'dataA':[{"maxSpeedVal":200,"speedVal":80}],"id":"#line15",'arcStartIndLabel':'No Risk','arcMiddleIndLabel':'Meter','arcEndIndLabel':'Total','textColor':'black'});
	...
	$("#areaChartMenu").click(function(){
		...
		stockChart.circleChart({'color':"red",'r':3,'data':data});
	...
	$("#pyramidChartMenu").click(function(){
		...
		$("#pyramidChart").find("#line13").empty();
		$("#pyramidChart").show();
	...
	$("#invertPyramidMenu").click(function(){
		$(".chartBigOuter").hide();
		$('#invertPyramid').find("#line17").empty();		
		$('#invertPyramid').show();
	...
	$("#meterChartMenu").click(function(){
		...
		$('#meterChart').find("#line18").empty();
		$('#meterChart').show();
		
		try{
		  
		  meterChart.init('line18','',380,320);
	...
	$("#groupedBar2DMenu").click(function(){
		...
		$("#groupedBar2D").find("#line19").empty();
		$("#groupedBar2D").show();
		
		var groupedChartData=generateDataForStackChart(-20);
		groupedChartData=groupedChartData.slice(0,groupedChartData.length-3)
		var stocChart19=$("#line19").stocCharts(textStyleConfg);
		var colorJson={"pending":"#7cb5ec","approved":"#434348","rejected":"#90ed7d","halted":"#f9b169"};
	...
	$("#3DPyramidChartMenu").click(function(){
		...
		$("#3DPyramidChart").find("#line20").empty();
		$("#3DPyramidChart").show();
	...
	$("#3DPyramidSliceChartMenu").click(function(){
		...
		$("#3DPyramidSliceChart").find("#line21").empty();
	...
	$("#dountChartWithLegendMenu").click(function(){
		...
		$("#dountChartWithLegend").find("#line22").empty();
		...
		var stocChart21=$("#line22").stocCharts(textStyleConfg);
	...
	$("#dountWithBarChartMenu").click(function(){
		...
		$("#dountWithBarChart").find("#line23").empty();
		...
		var stocChart23=$("#line23").stocCharts(textStyleConfg);
	...
	$("#BulletBarChartMenu").click(function(){
		...
		$("#BulletBarChart").find("#line24").empty();
		$("#BulletBarChart").show();
		...
		var stocChart24=$("#line24").stocCharts(textStyleConfg);
	...
	$("#CricketAnalChartMenu").click(function(){
		...
		$("#CricketAnalChart").find("#line25").empty();
	...
	$("#CombinationalChartMenu").click(function(){
		...
		$("#CombinationalChart").find("#line26").empty();
		...
		var stocChart26=$("#line26").stocCharts(textStyleConfg);
	...
	$("#variationChartMenu").click(function(){
		...
		$("#variationChart").find("#line28").empty();
		$("#variationChart").show();
		...
		var textStyleConfg={"font-family":"Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif","font-size":"12","background":"none","font-color":"green","font-weight":300,"axisTextColor":"black","legendTextColor":"black"};	
		var cnfg={"data":variationData};
		var stocChart28=$("#line28").stocCharts(textStyleConfg);
	...
	$("#globChartMenu").click(function(){
		...
		var textStyleConfg={"font-family":"Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif","font-size":"12","background":"none","font-color":"green","font-weight":300,"axisTextColor":"black","legendTextColor":"black"};	
		var stocChart29=$("#line29").stocCharts(textStyleConfg);
	...
	$("#barWithLogoMenu").click(function(){
		...
		var stocChart30=$("#line30").stocCharts(textStyleConfg);
	...
	$("#3DBubbleChart").find("#line32").empty();
	$("#3DBubbleChart").show();
	...
	var textStyleConfg={"font-family":"Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif","font-size":"12","background":"none","font-color":"green","font-weight":300,"axisTextColor":"black","legendTextColor":"black"};	
	var stocChart32=$("#line32").stocCharts(textStyleConfg);
  ...
  "SubRoot": 
   [
     ...
     [
      ...
      {       
       "Element":"Fatty Fish"           
		...
		var textStyleConfg={"font-family":"Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif","font-size":"12","background":"none","font-color":"green","font-weight":300,"axisTextColor":"black","legendTextColor":"black"};	
		var stocChart33=$("#line33").stocCharts(textStyleConfg);
	...
	$("#areaChartWithVaryColorMenu").click(function(){
		...
		$("#areaChartWithVaryColor").find("#line34").empty();
	...
	$("#areaChartWithNegativeValueMenu").click(function(){
		...
		$("#areaChartWithNegativeValue").find("#line35").empty();
...
//						 conditionArrayBelowMidPoint : [{45:"green"},{35:"red"},{30:"yellow"}],
		...
		var cnfg={"data":data};
		var stocChart35=$("#line35").stocCharts(textStyleConfg);
	...
	$("#musicSpikesMenu").click(function(){
		...
		var cnfg={"data":data};
		var stocChart36=$("#line36").stocCharts(textStyleConfg);
	...
	$("#comparisonChartMenu").click(function(){
		...
		$("#comparisonChart").find("#line37").empty();
		...
		var cnfg={"data":data};
		var stocChart37=$("#line37").stocCharts(textStyleConfg);
	...
	$("#multipleDountChartMenu").click(function(){
		...
		$("#multipleDountChart").find("#line39").empty();
		...
		var stocChart39=$("#line39").stocCharts(textStyleConfg);
	...
	$("#barWithLabelChartMenu").click(function(){
		...
		$("#barWithLabelChart").find("#line40").empty();
		$("#barWithLabelChart").show();
		...
		var stocChart40=$("#line40").stocCharts(textStyleConfg);
	...
	$("#logoChartMenu").click(function(){
		...
		var stocChart41=$("#line41").stocCharts(textStyleConfg);
	...
	$("#multiAxisChartMenu").click(function(){
		...
		$("#multiAxisChart").find("#line42").empty();
		$("#multiAxisChart").show();
		...
		var stocChart42=$("#line42").stocCharts(textStyleConfg);
		stocChart42.multiAxisChartAnalysis(data);
	});
	
	$("#candleChartMenu").click(function(){
		$(".chartBigOuter").hide();

		$("#candleChart").find("#line43").empty();
		$("#candleChart").show();
		...
		var data =
			{
				...
				[
					{
						marks : [1,55,50,23,45,90,77,33,67,43,24,76,34,65,89,76,59,36,73,12,67,93,23,45,67,82,34,44,55,66,24,54,78],
						average : 45
					},
					{
						marks : [55,50,23,45,90,77,33,67,50,23,45,90,50,23,45,90,54,23,78,67,54,34,56,72,14,89,8,78,23,56,34,67,82,34,55,62,34,93,55,88,30,10,6],
						average : 35
					},
					{
						marks : [55,50,23,45,90,77,33,67,43,58,52,12,34,56,78,98,43,92,37,12,49,74,59,68,23,45,84,39,20,10,56],
						average : 55
					},
					{
						marks : [55,50,23,45,90,77,33,67,43,58,52,12,34,56,34,56,72,14,89,8,78,23,32,76,45,12,67,34,46,9,],
						average : 50
					},
					{
						marks : [55,50,23,45,90,77,33,67,76,34,65,89,76,59,36,73,12,67,93],
						average : 65
					},
					{
						marks : [55,50,23,45,90,77,33,67,78,23,56,34,67,82,34,55,62,34,12,22,93,55,88,23,21,33,22,20,26,28,21],
						average : 38
					},
				],  
				xAxisData : ["Work Sheet1","Work Sheet2","Work Sheet3","Work Sheet4","Work Sheet5","Work Sheet6"],
				verticalLineColor : "#aec785",
				horizontalLineColor : "#e67a77",
				circleColor : "green",
				xAxisLabel : "Work Sheet",
				yAxisLabel :"Mark's",
				unit : "%",
				legendArray : ['Average Marks'],
				legendColorArray : ['red']
			
			}
	
	var stocChart43=$("#line43").stocCharts(textStyleConfg);
		stocChart43.candleChartAnaalysis(data);
	});
