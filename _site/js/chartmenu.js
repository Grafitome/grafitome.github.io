...
$("#racingVisualization").click(function(){
 //	selectedChartIndex=$(this).attr("index");
	  ...
	  var data =
		{
				...
				[
					...
					},
					{
						...
						"units": "km/hr",
						"color": "#c932c0",
						"data" : [13,23,12,23,30,53,23,12,23,30,53,23,12,23,30,53,23,12,23,30,53,23,12,23,30,53,23,12,23,30]			
					},
					{
						"name" : "GEAR_SPEED",
						"units": "",
  ...
  stocChart55.racingVisualizationAnalysis(data,positionArray);
 });
