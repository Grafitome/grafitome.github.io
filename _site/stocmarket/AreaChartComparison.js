...
function initComparisonChart(symbol1,symbol2){
	firstSymbol="AA";//symbol1;
	secondSymbol="GE";//symbol2;
...
function drawAreaComparisonChart123(){
	var startDate1=getDate('start',1,'year');
	var endDate1=getDate('end','');
	getDataForSymbol(firstSymbol,startDate1,endDate1,function(firstSymbolDat){
...
function drawAreaComparisonChart(selectorElement2){
	...
	alert(ymaxAreaChart);
	ymaxAreaChart=ymaxAreaChart+20;
	var xScaleAreaChart=d3.time.scale().range([0,(widthOfComparisonChart-marginLeft)]).domain([xMinAreaChart,xMaxAreaChart]);
	...
	makeAreaComparisonChart('.areaComparisonChart1',areaSymbolData1,xMinAreaChart,xMaxAreaChart,yMinAreaChart,ymaxAreaChart,xScaleAreaChart,yScaleAreaComparisonChart,svgContainer,'#6E7C4B','#1C6900');
	makeAreaComparisonChart('.areaComparisonChart2',areaSymbolData2,xMinAreaChart,xMaxAreaChart,yMinAreaChart,ymaxAreaChart,xScaleAreaChart,yScaleAreaComparisonChart,svgContainer,'#AE0E00','#E3E400');
	makeAreaComparisonChart('.areaComparisonChart3',areaSymbolData3,xMinAreaChart,xMaxAreaChart,yMinAreaChart,ymaxAreaChart,xScaleAreaChart,yScaleAreaComparisonChart,svgContainer,'#green','white');
	drawXAxisComparisonChart(svgContainer,xAxisAreaComparisonChart);
	drawYAxisComparisonChart(svgContainer,yAxisAreaComparisonChart);
}
function makeAreaComparisonChart(className,data,xMinAreaChart,xMaxAreaChart,yMinAreaChart,ymaxAreaChart,xScaleAreaChart,yScaleAreaComparisonChart,svgContainer,color,lineColor){
	var turningPoints = [0];
...
function drawComparisonChart(selectorElement){
	...
	drawYAxisComparisonChart(svgContainer,yAxisBarComparisonChart);
}
...
function drawYAxisComparisonChart(svgContainer,yAxis){
